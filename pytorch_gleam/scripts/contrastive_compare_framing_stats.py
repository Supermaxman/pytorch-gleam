...
def main():
    ...
    print(
        "Total judged discovered framings: "
        f"{num_true_found_framings}/{num_total_found_framings} ({100*percent_true_found_framings:.1f}%)"
    )
    ...
    print(
        "Known framings judged as re-discovered: "
        f"{num_found_known_framings}/{num_total_known_framings} ({100*percent_found_known_framings:.1f}%)"
    )
    ...
    print("Total framings discovered distribution: ")
    print(
        "  Known framings judged as re-discovered: "
        f"{num_found_known_framings}/{num_total_found_framings} "
        f"({100*percent_found_known_framings_of_total_found:.1f}%)"
    )
    print(
        "  Unknown framings judged as discovered: "
        f"{num_found_unknown_framings}/{num_total_found_framings} "
        f"({100*percent_unknown_found_known_framings_of_total_found:.1f}%)"
    )
    print(
        "  Non framings judged: "
        f"{num_found_non_framings}/{num_total_found_framings} ({100*percent_found_non_framings:.1f}%)"
    )
