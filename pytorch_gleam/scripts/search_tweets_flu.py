...
def main():
    ...
    output_path = "/users/max/data/corpora/flu-vaccine-twitter/raw-v1"
    secrets_path = "private/secrets.json"
    with open(secrets_path, "r") as f:
        secrets = json.load(f)["twitter"]
    endpoint_url = "https://api.twitter.com/2/tweets/search/all"

    # terms which directly refer to vaccine
    ...
    # terms which refer to disease vaccine is for
    disease_terms = ["influenza", "flu", "H1N1", "H2N2", "H3N2", "H7N9", "H5N1", "influenzas", "influenze", "flus"]
    disease_query = " OR ".join(disease_terms)

    # terms which identify vaccination towards disease
    vaccinate_terms = [
        "jab",
        "vax",
        "vaccine",
