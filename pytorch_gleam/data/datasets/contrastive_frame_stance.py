...
from pytorch_gleam.data.collators import ContrastiveFrameStanceBatchCollator
...
class ContrastiveFrameStanceInferStanceDataset(ContrastiveFrameStanceDataset):
...
class ContrastiveFrameStanceDataModule(BaseDataModule):
    def __init__(
        self,
        frame_path: str,
        tokenizer_name: str,
        ...
        **kwargs
        ...
        if self.train_path is not None:
            self.train_dataset = ContrastiveFrameStanceDataset(
        ...
        if self.val_path is not None:
            val_triplet_dataset = ContrastiveFrameStanceDataset(
                pos_samples=self.pos_samples,
                neg_samples=self.neg_samples,
            ...
            val_infer_dataset = ContrastiveFrameStanceInferStanceDataset(
                pos_samples=1,
                neg_samples=1,
                data_path=self.val_path,
                frame_path=self.frame_path,
        ...
        if self.test_path is not None:
            test_triplet_dataset = ContrastiveFrameStanceDataset(
                pos_samples=self.pos_samples,
                neg_samples=self.neg_samples,
            ...
            test_infer_dataset = ContrastiveFrameStanceInferStanceDataset(
                pos_samples=1,
                neg_samples=1,
        ...
        if self.predict_path is not None:
            self.predict_dataset = ContrastiveFrameStanceInferStanceDataset(
                pos_samples=1,
                neg_samples=1,
    ...
    def create_collator(self):
        return ContrastiveFrameStanceBatchCollator(
